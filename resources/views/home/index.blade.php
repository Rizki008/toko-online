                    ...
                    <div class="hero-holder">
                        <div class="hero-message">
                            ...
                            <div class="buttons-holder">
                                ...
                                <a href="#" class="btn btn-lg btn-transparent"><span>Learn
                                        More</span></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
                    <a href="#">
                        <img src="frontend/img/shop/collection_1.jpg" alt="">
                ...
                <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
                    <a href="#">
                        <img src="frontend/img/shop/collection_2.jpg" alt="">
                        <div class="overlay"></div>
                        <div class="promo-inner valign">
                            <h2>accessories</h2>
                ...
                <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
                    <a href="#">
                        <img src="frontend/img/shop/collection_3.jpg" alt="">
                        <div class="overlay"></div>
                        <div class="promo-inner valign">
                            <h2>for him</h2>
            ...
            <div id="owl-testimonials" class="owl-carousel owl-theme text-center">
                ...
                <div class="item">
                    <div class="testimonial">
                        <p class="testimonial-text">I’am amazed, I should say thank you so much for your
                            awesome template. Design is so good and neat, every detail has been taken care these
                            team are realy amazing and talented! I will work only with this agency.</p>
                ...
                <div class="item">
                    <div class="testimonial">
                        <p class="testimonial-text">Needless to say, beautifully designed theme that serves
                            many purpose. Even more sutomers support is the best! Highly recommend this theme to
