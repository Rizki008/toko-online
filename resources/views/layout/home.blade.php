...
<head>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="/frontend//frontend/img/favicon.ico">
    <link rel="apple-touch-icon" href="/frontend//frontend/img/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/frontend//frontend/img/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/frontend//frontend/img/apple-touch-icon-114x114.png">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="widget footer-about-us">
                                    <img src="/frontend/img/logo_dark.png" alt="" class="logo">
